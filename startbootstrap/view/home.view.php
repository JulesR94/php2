...
<?php include("view/layout/nav.inc.php"); ?> <!-- Pour charger la barre de navigation -->
<?php include("view/layout/header.inc.php"); ?> <!-- Pour charger le header -->
...
<div class="container px-4 px-lg-5">
    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-md-10 col-lg-8 col-xl-7">
            ...
            <?php foreach ($data as $onedata) { ?> <!--Passe en revue le tableau data-->
...
<?php include("view/layout/footer.inc.php"); ?> <!--Pour charger le footer -->
